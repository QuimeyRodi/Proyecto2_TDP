...
se podrá modificar ninguna otra celda hasta que el error sea solucionado, o se vacie la celda.
Existe la posibilidad de crear un nuevo juego, reiniciando el tablero y tambien el temporizador. 
El juego será ganado si el jugador logra completar todo el tablero sin errores.
